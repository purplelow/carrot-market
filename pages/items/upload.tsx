  ...
  return (
    <Layout title="상품 등록" canGoBack>
      <div className="space-y-5 p-4">
        <div>
          <label className="border-gray300 flex h-48 w-full cursor-pointer items-center justify-center rounded-md border-2 border-dashed text-gray-600 hover:border-orange-500 hover:text-orange-500">
            <svg
              className="h-12 w-12"
              stroke="currentColor"
              fill="none"
