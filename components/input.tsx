      ...
      {kind === "text" ? (
        <div>
          <input
            ...
            {...register}
            type={type}
            className="w-full border-collapse appearance-none rounded-md border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
          />
        </div>
      ) : null}
      {kind === "price" ? (
